export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx1cf0baff3bfec4cd",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "3c281e9d77f2cdc8ba9882bd1e13410a",
  ...
  USERS: [
    {
      ...
      id: "ooog-5o66YrhoZA7vtirD9PWvgAc",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "lon5-c6jMpHI02GY7tHe8krGgu-L5S8ZMe823u7Yzrg",
      // 所在省份
      province: "西藏",
      // 所在城市
      city: "拉萨",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "香香宝", "year": "2001", "date": "01-24"},
        {"type": "生日", "name": "臭臭宝", "year": "1997", "date": "11-22"},
      ],
  ...
  CALLBACK_TEMPLATE_ID: "lon5-c6jMpHI02GY7tHe8krGgu-L5S8ZMe823u7Yzrg",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "ooog-5pEP1-51Rb614UPEixW_4lE",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
